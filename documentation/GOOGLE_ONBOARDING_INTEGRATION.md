...
## Overview
GrowwMatics AI integrates the Google Places API directly into the onboarding wizard. By using an intelligent autocomplete input in Step 4 ("Business Details"), users can search for their business natively, exactly like they would on Google Maps.
