        ...
        >
          ...
          {step === 'email' && (
            <View className="gap-4">
              <Text className="text-2xl font-extrabold text-white">Reset your password</Text>
          ...
          {step === 'otp' && (
            <View className="gap-4">
              <Text className="text-2xl font-extrabold text-white">Enter the code</Text>
              <Text className="mb-2 text-sm text-zinc-400">
              ...
              >
                <Text className={`text-sm font-semibold ${cooldown > 0 ? 'text-zinc-500' : 'text-brand-bright'}`}>
          ...
          {step === 'newPassword' && (
            <View className="gap-4">
              <Text className="text-2xl font-extrabold text-white">Create a new password</Text>
              <Text className="mb-2 text-sm text-zinc-400">Choose a strong password you haven't used before.</Text>
              <Field
          ...
          {step === 'done' && (
            <View className="items-center gap-4">
              ...
              <Text className="text-2xl font-extrabold text-white">Password reset</Text>
